...
p22 = input("Which HTTP method is commonly used to retrieve data from an API?")
if p22.lower() == "get":
  points += 1
  print("Correct! Points:",points,"/ 25")
else:
...
p23 = input("What does SSD stand for in computing?")
if p23.lower() == "solid state drive":
  points += 1
  print("Correct! Points:",points,"/ 25")
else:
...
p24 = input("Which Linux command is used to list files in the current directory?")
if p24.lower() == "ls":
  points += 1
  print("Correct! Points:",points,"/ 25")
else:
  print("Wrong! The command is ls.")

print()

p25 = input("What does VPN stand for?")
if p25.lower() == "virtual private network":
  points += 1
  print("Correct! Points:",points,"/ 25")
else:
